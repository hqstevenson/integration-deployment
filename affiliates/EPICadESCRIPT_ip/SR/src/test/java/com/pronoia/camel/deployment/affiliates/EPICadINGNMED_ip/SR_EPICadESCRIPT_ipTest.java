...
public class SR_EPICadESCRIPT_ipTest extends CamelBlueprintTestSupport {
    ...
    protected String getBlueprintDescriptor() {
        return "/OSGI-INF/blueprint/EPICadESCRIPT_ip.xml,/OSGI-INF/blueprint/SR_EPICadESCRIPT_ip.xml";
    }
